...
angular.module("rosefire",[]).service("Rosefire",["$window","$q","$rootScope",function(e,r,n){this.signIn=function(o){var i=r.defer();return e.Rosefire.signIn(o,function(e,r){e?i.reject(e):i.resolve(r),n.$apply()}),i.promise}}]);